...
# 
# mtrobson_frst_89 <- project(mtrobson_frst_89, crs(mtrobson)) %>%
#   classify(., rclmat, right = F)
# mtrobson_frst_99 <- project(mtrobson_frst_99, crs(mtrobson)) %>%
#   classify(., rclmat, right = F)
# mtrobson_frst_09 <- project(mtrobson_frst_09, crs(mtrobson)) %>%
#   classify(., rclmat, right = F)
# mtrobson_frst_19 <- project(mtrobson_frst_19, crs(mtrobson)) %>%
#   classify(., rclmat, right = F)
...
#     print(i)
#     mtrobson_crop_89 <-
#       terra::crop(mtrobson_89_masked, mtrobson_grid[i,], snap = "in")
#     
#     mtrobson_89_metrics <-
#       lsm_c_para_mn(mtrobson_crop_89) %>%
